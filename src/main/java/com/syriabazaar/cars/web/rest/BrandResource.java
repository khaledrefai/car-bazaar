...
/**
 * REST controller for managing {@link com.syriabazaar.cars.domain.Brand}.
 */
@RestController
...
public class BrandResource {
    ...
    public ResponseEntity<Brand> createBrand(@Valid @RequestBody Brand brand) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/brands/" + brand.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, brand.getId().toString()))
            .body(brand);
    }
