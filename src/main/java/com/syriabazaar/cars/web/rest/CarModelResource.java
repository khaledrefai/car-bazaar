...
/**
 * REST controller for managing {@link com.syriabazaar.cars.domain.CarModel}.
 */
@RestController
...
public class CarModelResource {
    ...
    public ResponseEntity<CarModel> createCarModel(@Valid @RequestBody CarModel carModel) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/car-models/" + carModel.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, carModel.getId().toString()))
            .body(carModel);
    }
    ...
    public ResponseEntity<CarModel> updateCarModel(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, carModel.getId().toString()))
            .body(carModel);
    }
    ...
    public ResponseEntity<CarModel> partialUpdateCarModel(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, carModel.getId().toString())
        );
    }
