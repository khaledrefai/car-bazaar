...
/**
 * REST controller for managing {@link com.syriabazaar.cars.domain.CarType}.
 */
@RestController
...
public class CarTypeResource {
    ...
    public ResponseEntity<CarType> createCarType(@Valid @RequestBody CarType carType) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/car-types/" + carType.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, carType.getId().toString()))
            .body(carType);
    }
    ...
    public ResponseEntity<CarType> partialUpdateCarType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, carType.getId().toString())
        );
    }
