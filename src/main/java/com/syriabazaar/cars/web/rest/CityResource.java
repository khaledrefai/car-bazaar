...
/**
 * REST controller for managing {@link com.syriabazaar.cars.domain.City}.
 */
@RestController
...
public class CityResource {
    ...
    public ResponseEntity<City> createCity(@Valid @RequestBody City city) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/cities/" + city.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, city.getId().toString()))
            .body(city);
    }
    ...
    public ResponseEntity<City> partialUpdateCity(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, city.getId().toString())
        );
    }
