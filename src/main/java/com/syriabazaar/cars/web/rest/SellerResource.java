...
/**
 * REST controller for managing {@link com.syriabazaar.cars.domain.Seller}.
 */
@RestController
...
public class SellerResource {
    ...
    public ResponseEntity<Seller> createSeller(@Valid @RequestBody Seller seller) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/sellers/" + seller.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, seller.getId().toString()))
            .body(seller);
    }
